...
This method first collets the RGB value in each of the images and do comparison within them. % more related surveys
...
thought:
1. target image: opencv get its sketch_t Àÿ√Ëª≠.  feature engineering.
